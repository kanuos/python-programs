...
# clothes. The result getting the table is encoded as an int value with 0=no, 1=maybe, 2=yes.
# If either of you is very stylish, 8 or more, then the result is 2 (yes). With the exception that
...
def date_fashion(you, date):
    if you >= 8 or date >= 8:
        ...
        table = 1
    print(f"date_fashion({you}, {date}) -> {table}")
